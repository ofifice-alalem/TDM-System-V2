...
{
    public function getReturnData(MarketerReturnRequest $return)
    {
        $return->load('items.product', 'marketer');
        ...
        return response()->json([
            ...
            'marketer'       => $return->marketer->full_name ?? '---',
            'marketer_phone' => $return->marketer->phone ?? '---',
