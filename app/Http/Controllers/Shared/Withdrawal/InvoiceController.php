...
class InvoiceController extends Controller
{
    ...
    public function generateWithdrawalInvoicePdf(MarketerWithdrawalRequest $withdrawal)
    {
        ...
        $data = [
            ...
            'approvedAt' => $withdrawal->approved_at ? $withdrawal->approved_at->format('Y-m-d H:i') : null,
            ...
            'rejectedAt' => $withdrawal->rejected_at ? $withdrawal->rejected_at->format('Y-m-d H:i') : null,
            ...
            'labels' => [
                ...
                'approvedAt' => $arabic->utf8Glyphs('تاريخ الموافقة'),
                'rejectedBy' => $arabic->utf8Glyphs('تم الرفض بواسطة'),
                'rejectedAt' => $arabic->utf8Glyphs('تاريخ الرفض'),
