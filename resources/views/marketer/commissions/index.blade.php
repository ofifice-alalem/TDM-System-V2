                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-dark-border">
                                ...
                                @if($transaction['type'] === 'commission' && $transaction['payment_id'])
                                    <a href="{{ route('marketer.payments.show', $transaction['payment_id']) }}" class="px-5 py-2.5 bg-gray-100 dark:bg-dark-bg rounded-xl flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:bg-primary-50 dark:hover:bg-primary-900/30 hover:text-primary-600 dark:hover:text-primary-400 transition-all font-bold text-sm">
                                        <span>عرض</span>
                                        <i data-lucide="arrow-left" class="w-4 h-4"></i>
                                    </a>
                                @elseif($transaction['type'] === 'withdrawal')
                                    <a href="{{ route('marketer.withdrawals.show', $transaction['id']) }}" class="px-5 py-2.5 bg-gray-100 dark:bg-dark-bg rounded-xl flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:bg-primary-50 dark:hover:bg-primary-900/30 hover:text-primary-600 dark:hover:text-primary-400 transition-all font-bold text-sm">
                                        <span>عرض</span>
                                        <i data-lucide="arrow-left" class="w-4 h-4"></i>
                                    </a>
                                @endif
