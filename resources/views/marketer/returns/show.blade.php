...
@section('title', 'تفاصيل طلب الإرجاع #' . $request->invoice_number)
                ...
                <div class="bg-white dark:bg-dark-card rounded-[2rem] p-4 md:p-8 shadow-xl shadow-gray-200/60 dark:shadow-none border border-gray-200 dark:border-dark-border relative overflow-hidden">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-dark-muted mt-2 mr-14 font-medium">قائمة الأصناف المراد إرجاعها للمخزن</p>
                        </div>
                        ...
                        @if(in_array($request->status, ['pending', 'approved']))
                            <div x-data="{ showCancel: false }">
                                ...
                                <div 
                                    ...
                                    <form action="{{ route('marketer.returns.cancel', $request) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
