            ...
            @if(isset($results['is_store_summary']))
                ...
                <div class="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border shadow-lg overflow-hidden">
                    <div class="p-6 border-b border-gray-200 dark:border-dark-border">
                        ...
                        {{-- Stats Grid --}}
                        <div class="grid grid-cols-3 divide-x divide-x-reverse divide-gray-100 dark:divide-dark-border border border-gray-100 dark:border-dark-border rounded-2xl overflow-hidden mb-4">
                        ...
                        <div class="relative rounded-2xl overflow-hidden">
                            ...
                            <div class="relative p-5">
                                <div class="flex items-center justify-between mb-3">
                                    <span class="text-white/80 text-xs font-bold tracking-wide">إجمالي الدين</span>
                                ...
                                <div class="mt-3 pt-3 border-t border-white/20 grid grid-cols-2 gap-2 text-xs">
                                    <div class="bg-white/10 rounded-lg px-3 py-2">
                                        ...
                                        <div class="text-white font-black">{{ number_format($results['total_debt'] - $pendingNet, 2) }} دينار</div>
                                    </div>
                                    <div class="bg-white/10 rounded-lg px-3 py-2">
                                        <div class="text-white/60 mb-0.5">معلق</div>
                                        <div class="text-white font-black">{{ number_format($pendingNet, 2) }} دينار</div>
                                    </div>
                                </div>
                                @endif
                            </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 dark:bg-dark-bg border-b border-gray-200 dark:border-dark-border">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-right text-xs font-bold text-gray-600 dark:text-gray-400">المبيعات</th>
                                    <th class="px-6 py-3 text-right text-xs font-bold text-gray-600 dark:text-gray-400">المدفوعات</th>
