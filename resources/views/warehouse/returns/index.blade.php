        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8">
                ...
                <div class="bg-white dark:bg-dark-card rounded-2xl p-4 shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-200 dark:border-dark-border mb-6">
                    <form method="GET" action="{{ route('warehouse.returns.index') }}" class="flex flex-col md:flex-row gap-3">
                        ...
                        <div class="flex gap-2 items-end">
                            ...
                            @if(request('from_date') || request('to_date') || request('marketer_id'))
                                <a href="{{ route('warehouse.returns.index', ['status' => request('status'), 'all' => request('all')]) }}" class="px-6 py-2.5 bg-gray-500 hover:bg-gray-600 text-white rounded-xl font-bold transition-all text-sm flex items-center gap-2 justify-center">
                ...
                @include('shared.returns._status-tabs', ['route' => fn($params) => route('warehouse.returns.index', $params)])
