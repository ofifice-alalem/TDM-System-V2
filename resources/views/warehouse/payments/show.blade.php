                ...
                <div class="bg-gray-50 dark:bg-dark-card/50 rounded-[1.5rem] border-2 border-dashed border-gray-200 dark:border-dark-border p-6">
                    ...
                    @if($payment->status === 'pending')
                        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-dark-border space-y-3">
                            <a href="{{ route('warehouse.payments.pdf', $payment) }}" target="_blank" class="w-full bg-gray-900 dark:bg-dark-bg text-white hover:bg-gray-800 dark:hover:bg-dark-card border border-transparent dark:border-dark-border py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-gray-200 dark:shadow-none flex items-center justify-center gap-2 group mb-3">
