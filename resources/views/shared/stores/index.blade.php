        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 animate-fade-in">
            <div class="bg-white dark:bg-dark-card rounded-3xl p-6 shadow-lg shadow-gray-200/60 dark:shadow-none border border-gray-200 dark:border-dark-border">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1 font-bold uppercase tracking-wider">ديون سابقة</p>
                        <p class="text-2xl font-black text-gray-900 dark:text-white">{{ number_format($totalOldDebt, 2) }} <span class="text-sm text-gray-500">دينار</span></p>
                    </div>
                </div>
            </div>
            <div class="bg-white dark:bg-dark-card rounded-3xl p-6 shadow-lg shadow-gray-200/60 dark:shadow-none border border-gray-200 dark:border-dark-border">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1 font-bold uppercase tracking-wider">إجمالي الفواتير</p>
            ...
            <div class="bg-white dark:bg-dark-card rounded-3xl p-6 shadow-lg shadow-gray-200/60 dark:shadow-none border border-gray-200 dark:border-dark-border">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center text-blue-600 dark:text-blue-400">
