...
<div class="bg-white dark:bg-dark-card rounded-[1.5rem] border border-gray-200 dark:border-dark-border p-8 shadow-lg shadow-gray-200/50 dark:shadow-sm lg:sticky lg:top-[150px]">
    ...
    <div class="relative space-y-6 before:absolute before:inset-0 before:mr-[21px] before:h-full before:w-0.5 before:bg-gradient-to-b before:from-gray-200 dark:before:from-dark-border before:via-gray-100 dark:before:via-dark-bg before:to-transparent">
        ...
        <div class="relative flex items-start gap-5">
            ...
            <div>
                <h4 class="font-bold text-gray-900 dark:text-white text-base mb-1">موافق عليه</h4>
                <p class="text-sm text-gray-500 dark:text-dark-muted leading-relaxed">تمت الموافقة والصرف</p>
            </div>
        </div>
        ...
        <div class="relative flex items-start gap-5">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-dark-muted leading-relaxed">تم الرفض من قبل الإدارة</p>
            </div>
        </div>
