            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 w-full">
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        <h3 class="text-xl md:text-lg font-black text-gray-900 dark:text-white">#{{ $payment->payment_number }}</h3>
                    </div>
                    ...
                    <div class="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 font-medium">
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <span class="font-bold text-emerald-600 dark:text-emerald-400">{{ number_format($payment->amount, 2) }} د.ل</span>
                        </div>
                    </div>
                </div>
