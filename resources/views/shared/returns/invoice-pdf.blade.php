...
<head>
    ...
    <style>
        ...
        * { font-family: 'Cairo', 'DejaVu Sans', sans-serif; }
        ...
        @endif
        .header { margin-bottom: 5px; background-color: #dc3545; color: white; padding: 5px; border-radius: 3px; display: table; width: 100%; }
        ...
        .info-box { background-color: #fff5f5; padding: 4px 8px; border-radius: 3px; margin-bottom: 5px; border: 1px solid #dc3545; text-align: right; }
        .info-row { display: inline-block; width: 48%; margin-bottom: 2px; font-size: 11px; text-align: right; font-weight: bold; }
        .label { font-weight: bold; color: #dc3545; font-size: 11px; }
        table { width: 100%; border-collapse: collapse; margin-top: 3px; }
        th { background-color: #dc3545; color: white; padding: 4px; text-align: center; font-weight: bold; font-size: 12px; }
        td { border: 1px solid #dc3545; padding: 3px; background-color: #ffffff; font-size: 11px; text-align: center; }
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @endforeach
            <tr style="background-color: #fff5f5; color: #dc3545; font-weight: bold;">
