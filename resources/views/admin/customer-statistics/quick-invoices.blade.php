...
<div class="min-h-screen py-6 sm:py-8">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-6 sm:mb-8">
            <a href="{{ route('admin.customer-statistics.index') }}" class="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 mb-4 transition-colors">
                <i data-lucide="arrow-right" class="w-5 h-5"></i>
                <span class="font-bold">العودة للإحصائيات</span>
            </a>
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white">الفواتير المكتملة</h1>
                ...
                <a href="{{ route('admin.customer-statistics.quick-invoices', array_merge(request()->query(), ['export' => 1])) }}" class="w-full sm:w-auto px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-md text-sm">
        ...
        <div class="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div class="bg-white dark:bg-dark-card rounded-2xl p-4 sm:p-5 border border-gray-200 dark:border-dark-border shadow-sm">
                <div class="flex items-center gap-3 mb-2">
                    <div class="w-9 h-9 bg-blue-100 dark:bg-blue-500/10 rounded-xl flex items-center justify-center shrink-0">
                ...
                <p class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white">{{ number_format($totalInvoices) }}</p>
            </div>
            <div class="bg-white dark:bg-dark-card rounded-2xl p-4 sm:p-5 border border-gray-200 dark:border-dark-border shadow-sm">
                <div class="flex items-center gap-3 mb-2">
                    <div class="w-9 h-9 bg-green-100 dark:bg-green-500/10 rounded-xl flex items-center justify-center shrink-0">
                ...
                <table class="w-full">
                    <thead class="bg-gradient-to-l from-gray-50 to-gray-100 dark:from-dark-bg dark:to-gray-800/50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">عدد الفواتير</th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-dark-border">
                        ...
                        <tr class="hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-all duration-200 {{ $index % 2 === 0 ? 'bg-white dark:bg-dark-card' : 'bg-gray-50/50 dark:bg-dark-bg/50' }}">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                            ...
                            <td class="px-6 py-4 text-center">
                                <span class="inline-flex items-center justify-center min-w-[50px] px-3 py-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg text-sm font-black">
                                    {{ number_format($customer->invoices_count) }}
                                </span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <span class="font-black text-lg text-green-600 dark:text-green-400">{{ number_format($customer->invoices_total ?? 0, 0) }}</span>
                ...
                <div class="p-4 hover:bg-gray-50 dark:hover:bg-dark-bg transition-colors">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="bg-blue-50 dark:bg-blue-500/10 rounded-xl p-3 text-center">
                            <p class="text-xs text-blue-600 dark:text-blue-400 font-bold mb-1">عدد الفواتير</p>
                            <p class="text-xl font-black text-blue-700 dark:text-blue-300">{{ number_format($customer->invoices_count) }}</p>
                        </div>
                        <div class="bg-green-50 dark:bg-green-500/10 rounded-xl p-3 text-center">
                            <p class="text-xs text-green-600 dark:text-green-400 font-bold mb-1">الإجمالي</p>
                            <p class="text-lg font-black text-green-700 dark:text-green-300">{{ number_format($customer->invoices_total ?? 0, 0) }}</p>
                        </div>
                    </div>
                </div>
                @empty
