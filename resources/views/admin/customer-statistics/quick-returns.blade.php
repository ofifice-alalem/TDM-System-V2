    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-6 sm:mb-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <a href="{{ route('admin.customer-statistics.quick-returns', array_merge(request()->query(), ['export' => 1])) }}" class="w-full sm:w-auto px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-md text-sm">
