...
<div style="page-break-after: always; min-height: 700px; text-align: center; padding: 60px 40px;">
    ...
    <table style="width: 80%; border-collapse: collapse; direction: rtl; margin: 0 auto;">
        <tr style="border-bottom: 1px solid #e2e8f0;">
            <td style="padding: 10px 12px; font-size: 12px; font-weight: bold; color: #0f172a; text-align: right; border: none;">{{ $labels['filterEntity'] }}</td>
        ...
        @if(!empty($labels['filterSearch']))
        <tr style="border-bottom: 1px solid #e2e8f0;">
            <td style="padding: 10px 12px; font-size: 12px; font-weight: bold; color: #0f172a; text-align: right; border: none;">{{ $labels['filterSearch'] }}</td>
            <td style="padding: 10px 12px; font-size: 11px; font-weight: bold; color: #64748b; text-align: right; border: none;">{{ $labels['filterSearchLabel'] }}</td>
        </tr>
        @endif
        @if(!empty($labels['filterProd']))
        <tr style="border-bottom: 1px solid #e2e8f0;">
