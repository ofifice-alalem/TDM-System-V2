...
<div class="min-h-screen py-8">
    <div class="max-w-2xl mx-auto px-4 space-y-6">
        ...
        <div>
            ...
            <h1 class="text-3xl font-black text-gray-900 dark:text-white mt-2">دمج العملاء</h1>
        ...
        <div class="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border p-6 shadow-sm"
             x-data="customerMerge()">

            <form method="POST" action="{{ route('admin.customer-merge.store') }}"
