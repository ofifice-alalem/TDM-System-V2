            ...
            <form method="GET" class="space-y-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    @if(request()->hasAny(['customer_id', 'operation', 'from_date', 'to_date']))
                        ...
                        <a href="{{ route('sales.statistics.index') }}" class="flex-1 sm:flex-none px-6 py-2.5 bg-gray-500 hover:bg-gray-600 text-white rounded-xl font-bold transition-all text-sm flex items-center justify-center gap-2">
