    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-black text-gray-900 dark:text-white">المرتجعات المكتملة</h1>
                ...
                <a href="{{ route('sales.statistics.quick-returns', array_merge(request()->query(), ['export' => 1])) }}" class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold transition-all flex items-center gap-2 shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div class="bg-white dark:bg-dark-card rounded-xl p-5 border border-gray-200 dark:border-dark-border shadow-sm hover:shadow-md transition-shadow">
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">إجمالي عدد المرتجعات</p>
                <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($totalReturns) }}</p>
            </div>
            <div class="bg-white dark:bg-dark-card rounded-xl p-5 border border-gray-200 dark:border-dark-border shadow-sm hover:shadow-md transition-shadow">
                ...
                <table class="w-full">
                    <thead class="bg-gray-50 dark:bg-dark-bg border-b border-gray-200 dark:border-dark-border">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">عدد المرتجعات</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-dark-border">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-dark-bg transition-colors">
                            ...
                            <td class="px-6 py-4 text-center font-black text-lg text-red-600 dark:text-red-400">
                                {{ number_format($customer->returns_total ?? 0, 0) }} دينار
                            </td>
                        </tr>
                        @empty
                        <tr>
