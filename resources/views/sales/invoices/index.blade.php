            ...
            <details class="bg-white dark:bg-dark-card rounded-2xl shadow-lg shadow-gray-200/60 dark:shadow-none border border-gray-200 dark:border-dark-border overflow-hidden">
                <summary class="px-6 py-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-dark-bg transition-colors flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        @if(request()->hasAny(['invoice_number', 'customer', 'date_from', 'date_to', 'amount_from', 'amount_to', 'status', 'sort']))
                ...
                <form method="GET" class="p-6 border-t border-gray-200 dark:border-dark-border">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-600 dark:text-gray-400 mb-2">الترتيب</label>
                            <select name="sort" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-dark-bg border border-gray-200 dark:border-dark-border rounded-xl text-gray-900 dark:text-white focus:border-primary-500 focus:ring-2 focus:ring-primary-100 dark:focus:ring-primary-500/20 transition-all">
                                <option value="date_desc" {{ request('sort', 'date_desc') === 'date_desc' ? 'selected' : '' }}>التاريخ (الأحدث)</option>
                                <option value="date_asc" {{ request('sort') === 'date_asc' ? 'selected' : '' }}>التاريخ (الأقدم)</option>
                                <option value="amount_desc" {{ request('sort') === 'amount_desc' ? 'selected' : '' }}>المبلغ (الأعلى)</option>
                                <option value="amount_asc" {{ request('sort') === 'amount_asc' ? 'selected' : '' }}>المبلغ (الأقل)</option>
                            </select>
                        </div>
                        <div>
