    ...
    <div class="max-w-[1600px] mx-auto space-y-8 px-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-fade-in-down">
            ...
            <div class="lg:col-span-4 lg:translate-y-[30px]">
                <a href="{{ route('sales.payments.create') }}" class="px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-bold transition-all shadow-lg shadow-primary-200/50 dark:shadow-none flex items-center justify-center gap-2 w-full">
